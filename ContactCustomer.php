<?php  
    ...
    $sql = "SELECT * FROM ContactMailBox WHERE Receiver='Admin'";
...
<DOCTPYE html>
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="AdminPortal.php" class="text-indigo-800 hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Modify Tours</a>
              <a href="ContactCustomer.php" class="bg-indigo-800 text-white rounded-md px-3 py-2 text-sm font-medium">Contact Customer</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Message Customers</h1>
    </div>
  </header>
  <main>
    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        ?>
        <form action="MessageCustomer.php" method="POST">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Message Customer</button>
    </div>
    </form>
    </div>
  </main>
