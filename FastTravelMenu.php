<?php  
    ...
    $sql = "SELECT * FROM UserTours WHERE Name = '$Name'";
...
<DOCTPYE html>
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="FastTravelMenu.php" class="bg-indigo-800 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">My Tours</a>
              <a href="AvailableTours.php" class="text-indigo-800 hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Available tours</a>
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">My Tours</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <?php 
           while ($row = $result->fetch_assoc()) {
            ...
            echo "<h1>Tour Location:$Tour,  Number of travelers:$Numtravelers, Total:$$Total</h1>
            ";
        }
        $statement->close();
        $conn->close();
