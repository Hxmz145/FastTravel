...
<DOCTPYE html>
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="ContactAdmin.php" class="text-indigo-800 hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Contact Admin</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <p class="mt-1 text-sm leading-6 text-gray-600">You can modify your profile here</p>
        <div class="sm:col-span-4">
          <label for="date" class="block text-sm font-medium leading-6 text-gray-900">Email</label>
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                <input type="hidden" name="email" id="email" value="<?php echo $current_email ?>">
              <input type="text" name="NewEmail" id="NewEmail" autocomplete="NewEmail" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="<?php echo $current_email ?>">
            </div>
          </div>
        ...
        <div class="sm:col-span-4">
          <label for="capacity" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
              
              <input type="password" name="newpassword" id="newpassword" autocomplete="newpassword" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
            </div>
          </div>
      </div>
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Modify Profile</button>
  </div>
</form>
    </div>
  </main>
